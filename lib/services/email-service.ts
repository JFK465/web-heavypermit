...
const PROJECT_ID = "heavypermit";
const PROJECT_DOMAIN = "schwertransport-genehmigung.de";
const PROJECT_DISPLAY_NAME = "HeavyPermit";
const PROJECT_PRIMARY_COLOR = "#2563EB";
const PROJECT_ACCENT_COLOR = "#1E40AF";
const PROJECT_ADMIN_EMAIL = "info@schwertransport-genehmigung.de";
const PROJECT_TAGLINE = "Genehmigungs-Management mit Ampelsystem (gültig/läuft ab/abgelaufen) zur zentralen Verwaltung aller Schwertransport-Genehmigungen";
