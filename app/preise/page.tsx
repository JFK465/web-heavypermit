...
export const metadata: Metadata = generateSEOMetadata({
  ...
  keywords: [
    "HeavyPermit Preise",
    "Schwertransport Software Kosten",
    "Genehmigungs-Management Preis",
  ],
  canonical: "/preise",
});
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { position: 2, name: "Preise", item: `${SITE_URL}/preise` },
        ]}
      />
      <WebPageSchema
        name="Preise - HeavyPermit"
        description="Transparenter Preis für HeavyPermit: 499€/Monat Basis + 20€ pro LKW. Testen Sie jetzt kostenlos in der Beta!"
        url={`${SITE_URL}/preise`}
      />
            ...
            <div className="space-y-6">
              <div className="bg-white rounded-xl p-6 shadow-md">
                ...
                <p className="text-gray-600">
                  ...
                  Keine Kreditkarte erforderlich. Kontaktieren Sie uns für den
                  Zugang.
                </p>
              </div>
              <div className="bg-white rounded-xl p-6 shadow-md">
                ...
                <p className="text-gray-600">
                  Ja, Sie können jederzeit zum Monatsende kündigen. Es gibt
                  keine Mindestlaufzeit oder versteckte Kündigungsgebühren.
                </p>
              </div>
              <div className="bg-white rounded-xl p-6 shadow-md">
                <h3 className="text-lg font-semibold text-gray-900 mb-2">
                ...
                <p className="text-gray-600">
                  Sie zahlen einfach 20€ pro zusätzlichem LKW. Der
                  Professional-Plan ist unbegrenzt, Sie zahlen also nie mehr als
                  die Grundgebühr + 20€ pro LKW.
                </p>
              </div>
              <div className="bg-white rounded-xl p-6 shadow-md">
                <h3 className="text-lg font-semibold text-gray-900 mb-2">
