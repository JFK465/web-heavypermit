...
export const metadata: Metadata = generateSEOMetadata({
  ...
  description:
    "Die richtige Software für Speditionen: Transportmanagement, Genehmigungsverwaltung und Fuhrpark-Disposition. Optimize your operations.",
  keywords: [
    "Spedition Software",
    "Software Spedition",
    "Transportsoftware",
...
export default function SpeditionSoftwarePage() {
  return (
    <>
      ...
      />
      <WebPageSchema
        name="Spedition Software - Software für Speditionen und Schwertransporte"
      ...
      <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
        <div className="container mx-auto px-4 py-16">
          ...
          <div className="text-sm text-gray-500 mb-6">
            ...
            / <span className="text-gray-700">Spedition Software</span>
          </div>
          ...
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            <p className="text-xl text-gray-600 mb-8">
              Die richtige Software für Ihre Spedition: Von der
              Genehmigungsverwaltung bis zur kompletten Transport-Disposition.
            </p>
          ...
          <div className="max-w-4xl mx-auto space-y-12">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="flex items-start gap-3 p-4 bg-green-50 rounded-xl">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Zentrale Verwaltung aller Schwertransport-Genehmigungen
                      mit Ablaufkontrolle
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3 p-4 bg-blue-50 rounded-xl">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Optimierte Routenplanung unter Berücksichtigung von
                      Genehmigungen
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3 p-4 bg-yellow-50 rounded-xl">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Komplette Übersicht über alle Fahrzeuge, Wartung und
                      Einsätze
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3 p-4 bg-purple-50 rounded-xl">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Erinnerungen an Verlängerungen, Wartungen und
                      Genehmigungsabläufe
                    </p>
                  </div>
                </div>
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Keine manuellen Excel-Listen mehr. Alle Daten zentral und
                      sofort verfügbar.
                    </p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Automatische Kontrolle verhindert teure Fehler durch
                      abgelaufene Genehmigungen.
                    </p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Optimierte Tourenplanung erhöht die Auslastung und
                ...
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Alle Nachweise jederzeit verfügbar für Audits und
                      Kontrollen.
                    </p>
                  </div>
                </li>
            ...
            <section className="bg-white rounded-2xl p-8 shadow-md">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <div className="text-center p-6 bg-gray-50 rounded-xl">
                  ...
                  <p className="text-sm text-gray-600">
                    Alle Arten von Speditionen, von Fernverkehr bis
                    Spezialtransporte
                  </p>
                </div>
                <div className="text-center p-6 bg-gray-50 rounded-xl">
                  ...
                  <p className="text-sm text-gray-600">
                    Speziell für Unternehmen mit Genehmigungspflichtigen
                    Transporten
                  </p>
                </div>
                <div className="text-center p-6 bg-gray-50 rounded-xl">
                  ...
                  <p className="text-sm text-gray-600">
                    Betriebe mit eigenen LKW-Flotten für Materialtransporte
                  </p>
                </div>
              </div>
            </section>
            ...
            <section className="bg-white rounded-2xl p-8 shadow-md">
              ...
              <p className="text-gray-600 mb-6">
                Die Kosten für Spedition Software variieren je nach
                Funktionsumfang und Anbieter:
              </p>
              ...
              <p className="text-gray-600 mt-4">
                HeavyPermit bietet eine transparente Preisgestaltung: 499€/Monat
                + 20€/LKW. Keine versteckten Kosten, keine Setup-Gebühren.
              </p>
            </section>
            ...
            <section className="bg-gradient-to-br from-blue-900 to-blue-800 rounded-2xl p-8 text-white text-center">
              ...
              <p className="text-blue-100 mb-6">
                Testen Sie HeavyPermit jetzt kostenlos und sehen Sie, wie viel
                Zeit und Geld Sie sparen können.
              </p>
              <Link
