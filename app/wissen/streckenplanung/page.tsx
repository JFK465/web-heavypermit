...
export const metadata: Metadata = {
  ...
  description:
    "So planen Sie optimale Routen für Schwertransporte unter Berücksichtigung aller Vorschriften und Genehmigungen.",
};
      ...
      <BreadcrumbSchema
        items={[
          ...
          { position: 2, name: "Wissen", item: `${SITE_URL}/wissen` },
          {
            ...
            item: `${SITE_URL}/wissen/streckenplanung`,
          },
        ]}
      />
      <WebPageSchema
        name="Streckenplanung für Schwertransporte - HeavyPermit"
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-lg text-gray-600 mb-8">
              Wie Sie optimale Routen für Schwertransporte planen und alle
            ...
            <div className="bg-white rounded-xl shadow-md p-8 space-y-8">
              <section>
                ...
                <p className="text-gray-600 mb-4">
                  Die Planung von Routen für Schwertransporte erfordert deutlich
                  mehr Aufwand als bei normalen LKW-Transports. Neben den
                  üblichen Faktoren wie Entfernung und Verkehr müssen zahlreiche
              ...
              <section>
                ...
                <p className="text-gray-600 mb-4">
                  Nicht alle Straßen sind für Schwertransporte freigegeben.
                  Bestimmte Streckenabschnitte erfordern besondere Genehmigungen
                  oder sind komplett gesperrt.
                </p>
                <p className="text-gray-600">
                  Informieren Sie sich vorab bei den zuständigen
                  Straßenverkehrsbehörden über:
                </p>
              ...
              <section>
                ...
                <p className="text-gray-600 mb-4">
                  Moderne Software-Lösungen unterstützen bei der Routenplanung.
                  HeavyPermit bietet Ihnen eine Übersicht über alle relevanten
                  Strecken und warnt Sie vor problematischen Abschnitten.
                </p>
                <div className="p-4 bg-blue-50 rounded-lg">
                  <h3 className="font-semibold text-blue-900 mb-2">Tipp:</h3>
                  <p className="text-blue-800">
                    Planen Sie immer eine Alternativroute ein. So sind Sie vor
                    Verzögerungen durch unvorhergesehene Ereignisse wie Unfälle
                    oder Straßensperrungen geschützt.
                  </p>
                </div>
              </section>
              ...
              <section>
                ...
                <p className="text-gray-600 mb-4">
                  Bei der Streckenplanung spielt auch der Zeitfaktor eine
                  wichtige Rolle:
                </p>
                <ul className="list-disc pl-6 text-gray-600 space-y-2">
                  <li>
                    <strong>Verkehrsarme Zeiten:</strong> Meiden Sie Stoßzeiten
                    und Hauptverkehrszeiten
                  </li>
                  <li>
                    <strong>Feiertage:</strong> An Feiertagen gelten oft
                    Sonderregelungen
                  </li>
                  <li>
                    <strong>Escort-Zeiten:</strong> Begleitfahrzeuge sind nicht
                    rund um die Uhr verfügbar
                  </li>
                  <li>
                    <strong>Behördenzeiten:</strong> Genehmigungen gelten oft
              ...
              <section className="pt-8 border-t">
                ...
                <p className="text-gray-600">
                  Eine sorgfältige Streckenplanung ist der Schlüssel zu
                  erfolgreichen Schwertransporten. Mit der richtigen
                  Vorbereitung und einem guten Genehmigungs-Management vermeiden
                  Sie Verzögerungen und Bußgelder.
                </p>
              </section>
            </div>
