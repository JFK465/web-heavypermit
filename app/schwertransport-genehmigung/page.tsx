...
export const metadata: Metadata = generateSEOMetadata({
  ...
  description:
    "Erfordernis, Beantragung, Kosten und Gültigkeit von Schwertransport-Genehmigungen in Deutschland. So vermeiden Sie Bußgelder.",
  keywords: [
    "Schwertransport Genehmigung",
    "Schwertransport Genehmigung Deutschland",
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          {
            position: 2,
            name: "Schwertransport Genehmigung",
            item: `${SITE_URL}/schwertransport-genehmigung`,
          },
        ]}
      />
      <WebPageSchema
        name="Schwertransport Genehmigung - Alles was Sie wissen müssen"
      ...
      <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
        <div className="container mx-auto px-4 py-16">
          ...
          <div className="text-sm text-gray-500 mb-6">
            ...
            / <span className="text-gray-700">Schwertransport Genehmigung</span>
          </div>
          ...
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            <p className="text-xl text-gray-600 mb-8">
              Alles was Sie über Genehmigungen für Schwertransporte wissen
              müssen: Von der Beantragung bis zur Gültigkeit.
            </p>
          ...
          <div className="max-w-4xl mx-auto space-y-12">
            ...
            <section className="bg-white rounded-2xl p-8 shadow-md">
              ...
              <p className="text-gray-600 mb-4">
                Eine Schwertransport Genehmigung ist eine behördliche Erlaubnis,
                die es Ihnen ermöglicht, Transportfahrten mit außergewöhnlichen
                Abmessungen (Überbreite, Überhöhe, Überlänge) oder mit einem
                außergewöhnlichen Gewicht durchzuführen.
              </p>
              <p className="text-gray-600">
                In Deutschland sind dafür verschiedene Behörden zuständig: Die
                Landesämter für Straßenbau und Verkehr für einzelne Bundesländer
                oder die Bundesanstalt für Straßenwesen (BASt) für bundesweite
                Genehmigungen.
              </p>
            </section>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-4 p-4 bg-gray-50 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Stellen Sie den Antrag online über das ViA-Projekt der
                      BASt oder bei Ihrem zuständigen Landesamt.
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-4 p-4 bg-gray-50 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Die Behörde prüft die Route auf Streckeneignung und
                      genehmigt eventuelle Begleitfahrzeuge.
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-4 p-4 bg-gray-50 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Nach Bearbeitung (i.d.R. 2-4 Wochen) erhalten Sie die
                      Genehmigung mit Auflagen und Gültigkeitsdauer.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <section className="bg-white rounded-2xl p-8 shadow-md">
              ...
              <p className="text-gray-600 mb-4">
                Die Kosten setzen sich aus verschiedenen Gebühren zusammen und
                richten sich nach Gewicht, Abmessungen und Streckenlänge:
              </p>
              <div className="bg-gray-50 p-6 rounded-lg">
                <ul className="space-y-2 text-gray-700">
                  ...
                  <li className="flex justify-between">
                    <span>Je Tonne Übergewicht:</span>{" "}
                    <span className="font-medium">1€ - 5€</span>
                  </li>
                  <li className="flex justify-between">
                    <span>Je km Strecke:</span>{" "}
                    <span className="font-medium">0,50€ - 2€</span>
                  </li>
                  <li className="flex justify-between">
                    <span>Eilantrag (Zuschlag):</span>{" "}
            ...
            <section className="bg-gradient-to-br from-blue-900 to-blue-800 rounded-2xl p-8 text-white text-center">
              ...
              <p className="text-blue-100 mb-6">
                HeavyPermit hilft Ihnen, den Überblick über alle Genehmigungen
                zu behalten. Automatische Erinnerungen, wenn Genehmigungen
                ablaufen.
              </p>
              <Link
                href="/tools/genehmigungs-checker"
