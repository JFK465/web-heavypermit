...
export const metadata: Metadata = generateSEOMetadata({
  ...
  description:
    "LKW Genehmigung für Schwertransporte online beantragen. Alle Informationen zu Kosten, Dauer und Anforderungen.",
  keywords: [
    "LKW Genehmigung",
    "LKW Genehmigung online",
    "LKW Genehmigung Deutschland",
    "Sattelzug Genehmigung",
  ],
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          {
            position: 2,
            name: "LKW Genehmigung",
            item: `${SITE_URL}/lkw-genehmigung`,
          },
        ]}
      />
      <WebPageSchema
        name="LKW Genehmigung online beantragen - Deutschland"
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl text-gray-600 mb-8">
              Wie Sie eine LKW Genehmigung für Schwertransporte in Deutschland
              beantragen.
            </p>
            ...
            <div className="space-y-8">
              ...
              <section className="bg-white rounded-2xl p-8 shadow-md">
                ...
                <p className="text-gray-600 mb-4">
                  Die Beantragung erfolgt über das ViA-Portal der Bundesanstalt
                  für Straßenwesen:
                </p>
              ...
              <section className="bg-gradient-to-br from-blue-900 to-blue-800 rounded-2xl p-8 text-white text-center">
                ...
                <p className="text-blue-100 mb-6">
                  HeavyPermit hilft Ihnen, alle Ihre LKW Genehmigungen zu
                  verwalten und keine zu vergessen.
                </p>
                <Link
