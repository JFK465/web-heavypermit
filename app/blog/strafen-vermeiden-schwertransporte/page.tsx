...
export const metadata: Metadata = generateSEOMetadata({
  ...
  description:
    "Was kostet das Fahren ohne Genehmigung? Bußgelder, Stilllegung und wie Sie diese vermeiden.",
  keywords: [
    "Strafen Schwertransport",
    "Bussgeld ohne Genehmigung",
    "Stilllegung LKW",
  ],
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          {
            position: 3,
            name: "Strafen bei fehlender Genehmigung vermeiden",
            item: `${SITE_URL}/blog/strafen-vermeiden-schwertransporte`,
          },
        ]}
      />
      <ArticleSchema
        headline="Strafen bei fehlender Genehmigung vermeiden"
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <article className="prose prose-lg max-w-none">
              <p className="text-xl text-gray-600 mb-8">
                Ein einziger Fehler kann Tausende Euro kosten. Erfahren Sie, wie
                Sie Strafen und Bußgelder bei Schwertransporten vermeiden.
              </p>
              ...
              <ul>
                <li>
                  <strong>Stilllegung:</strong> Das Fahrzeug kann vor Ort
                  stillgelegt werden
                </li>
                <li>
                  <strong>Punkte:</strong> Eintragung in das
                  Fahreignungsregister (bis 3 Punkte)
                </li>
                <li>
                  <strong>Strafverfahren:</strong> Bei grober Fahrlässigkeit
                  strafrechtliche Konsequenzen
                </li>
                <li>
                  <strong>Schadenersatz:</strong> Bei Schäden an Infrastruktur
                  haftbar
                </li>
              </ul>
