...
export const metadata: Metadata = generateSEOMetadata({
  ...
  description:
    "Welche Genehmigungspflichten gelten für Speditionen bei Schwertransporten? Rechtliche Übersicht und praktische Tipps.",
  keywords: [
    "Genehmigungspflichten Spedition",
    "Spedition Rechtliches",
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          {
            position: 3,
            name: "Genehmigungspflichten für Speditionen",
            item: `${SITE_URL}/blog/genehmigungs-pflichten-spediteure`,
          },
        ]}
      />
      <ArticleSchema
        headline="Genehmigungspflichten für Speditionen - Was Sie wissen müssen"
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <article className="prose prose-lg max-w-none">
              <p className="text-xl text-gray-600 mb-8">
                Als Spedition müssen Sie zahlreiche Genehmigungspflichten
                beachten. Dieser Artikel gibt Ihnen einen Überblick über die
                wichtigsten Regelungen.
              </p>

              <h2>Grundlagen der Genehmigungspflicht</h2>
              <p>
                Nach § 29 Abs. 3 StVO können von den allgemeinen Verkehrsregeln
                Ausnahmen genehmigt werden, wenn dies zur Durchführung von
                Transporten mit außergewöhnlichen Abmessungen oder Gewichten
                erforderlich ist.
              </p>
              ...
              <p>
                Gilt für einen einzelnen Transport mit festgelegter Route, Datum
                und Uhrzeit. Die Bearbeitungszeit beträgt in der Regel 2-4
                Wochen.
              </p>

              <h3>2. Dauergenehmigung</h3>
              <p>
                Gilt für regelmäßig wiederkehrende Transporte auf derselben
                Route. Die Gültigkeitsdauer kann bis zu 3 Jahre betragen.
              </p>
              ...
              <p>
                Das Fahren ohne gültige Genehmigung kann erhebliche Konsequenzen
                haben:
              </p>
              <ul>
              ...
              <h2>Fazit</h2>
              <p>
                Die Einhaltung der Genehmigungspflichten ist für Speditionen
                essentiell. Mit einer guten Verwaltung und automatischen
                Erinnerungen können Sie teure Fehler vermeiden.
              </p>
            </article>
          </div>
        </div>
