...
export const metadata: Metadata = generateSEOMetadata({
  ...
  description:
    "Genehmigung für Großraumtransporte: Abmessungen, Kosten und Beantragung in Deutschland. So funktioniert's.",
  keywords: [
    "Grossraumtransport Genehmigung",
    "Grossraumtransport Genehmigung Deutschland",
    "Sondertransporte Genehmigung",
    "Ausnahmetransport",
  ],
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          {
            position: 2,
            name: "Großraumtransport Genehmigung",
            item: `${SITE_URL}/grossraumtransport-genehmigung`,
          },
        ]}
      />
      <WebPageSchema
        name="Großraumtransport Genehmigung - Was Sie wissen müssen"
      ...
      <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
        <div className="container mx-auto px-4 py-16">
          ...
          <div className="text-sm text-gray-500 mb-6">
            ...
            / <span className="text-gray-700">Großraumtransport</span>
          </div>
            ...
            <div className="space-y-8">
              ...
              <section className="bg-white rounded-2xl p-8 shadow-md">
                ...
                <p className="text-gray-600 mb-4">
                  Ein Großraumtransport liegt vor, wenn die Ladung folgende
                ...
                <div className="space-y-4">
                  <div className="p-4 bg-blue-50 rounded-xl">
                    ...
                    <p className="text-gray-600">
                      Gilt für regelmäßig wiederkehrende Transporte auf
                      derselben Route. Gültig bis zu 3 Jahren.
                    </p>
                  </div>
                  <div className="p-4 bg-green-50 rounded-xl">
                    ...
                    <p className="text-gray-600">
                      Gilt für einen einzelnen Transport mit festgelegter Route
                      und Datum.
                    </p>
                  </div>
                  <div className="p-4 bg-yellow-50 rounded-xl">
                    ...
                    <p className="text-gray-600">
                      Für grenzüberschreitende Transporte innerhalb Europas
                      erforderlich.
                    </p>
                  </div>
                </div>
              ...
              <section className="bg-gradient-to-br from-blue-900 to-blue-800 rounded-2xl p-8 text-white text-center">
                ...
                <p className="text-blue-100 mb-6">
                  Mit HeavyPermit haben Sie alle Ihre Großraumtransport
                  Genehmigungen immer im Blick.
                </p>
                <Link
