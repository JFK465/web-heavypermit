...
export const metadata: Metadata = generateSEOMetadata({
  ...
  description:
    "HeavyPermit Lösungen für Speditionen, Bauunternehmen, Maschinenbau und weitere Branchen mit Schwertransport-Bedarf.",
  keywords: [
    "Lösungen Schwertransport",
    "Branchenlösungen Spedition",
    "Genehmigungsmanagement Branchen",
  ],
  canonical: "/loesungen",
});
  ...
  const branchen = [
    {
      ...
      name: "Speditionen",
      beschreibung:
        "Spezialisierte Speditionen für Schwer- und Großraumtransporte",
      features: [
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { position: 2, name: "Lösungen", item: `${SITE_URL}/loesungen` },
        ]}
      />
      <WebPageSchema
        name="Lösungen - HeavyPermit für verschiedene Branchen"
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              HeavyPermit passt sich an Ihre Anforderungen an - egal ob
              Spedition, Bauunternehmen oder Maschinenbau.
            </p>
          </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {branchen.map((branche) => (
                ...
                >
                  ...
                  <p className="text-gray-600 mb-6">{branche.beschreibung}</p>
